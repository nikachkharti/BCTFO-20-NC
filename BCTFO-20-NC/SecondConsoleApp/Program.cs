...
namespace SecondConsoleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //1. შექმენით Vehicle კლასი ექსელის ფაილში არსებული მონცაემენბის შესაბმისად.
            //2. მოიფიქრეთ ფუნქციონალი როგორ გადააკეთოთ ტექსტურ ფაილში არსებული ერთი ელემენტი მანქანის ობიექტად.
            //3. მოიფიქრეთ როგორ გადააკეთოთ ტექსტურ ფაილში არსებული ყველა ელემენტი მანქანის ობიექტებად და დაიმახსოვროთ შესაბამის ლისტში ან მასივში.

            //4.მოძებნეთ ყველა მერსედესი.
